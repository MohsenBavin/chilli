...
public class EduSpinnerAdapter extends BaseAdapter {
    private Context context;
   // private int[] eduFlagIds;
    private String[] eduName;
    private LayoutInflater inflater;

    public EduSpinnerAdapter(Context context , String[] eduName){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      //  View view=inflater.inflate( R.layout.spinner_educate_layout_item ,parent,false);
        ...
        if(convertView==null){
            ...
            convertView=inflater.inflate( R.layout.spinner_educate_layout_item ,parent,false);
            holder=new ViewHolder();
            holder.textEdu=(TextView)convertView.findViewById( R.id.text_step_item );
